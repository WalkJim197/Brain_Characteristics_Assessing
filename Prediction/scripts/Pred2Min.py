...
# data_label.to_excel('E:\ASD\PostPrep\prediction\precessed data\ic_resultsGIG.xlsx',sheet_name='GIG')

plt.figure(figsize=(10,10))
sns.set_style("white")
ax = sns.regplot(x=target, y=pred, fit_reg=True, scatter_kws={"s": 100, "color": "black"}, line_kws={"color": "darkblue"})
